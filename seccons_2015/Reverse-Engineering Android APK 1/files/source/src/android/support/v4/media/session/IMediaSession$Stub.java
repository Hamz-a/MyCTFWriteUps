...
//            IMediaSession, ParcelableVolumeInfo, PlaybackStateCompat, IMediaControllerCallback
...
_L1:
        ...
        throws RemoteException
    {
        ...
        case 1: // '\001'
            ...
            if (parcel.readInt() != 0)
            {
                parcel = (ResultReceiverWrapper)ResultReceiverWrapper.CREATOR.createFromParcel(parcel);
            } else
            {
                parcel = null;
            }
        ...
        case 3: // '\003'
            parcel.enforceInterface("android.support.v4.media.session.IMediaSession");
            registerCallbackListener(lback.Stub.asInterface(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;

        case 4: // '\004'
            parcel.enforceInterface("android.support.v4.media.session.IMediaSession");
            unregisterCallbackListener(lback.Stub.asInterface(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;
