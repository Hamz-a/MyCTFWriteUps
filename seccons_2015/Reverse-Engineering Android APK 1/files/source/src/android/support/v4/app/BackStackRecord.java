    ...
    private boolean configureTransitions(int i, TransitionState transitionstate, boolean flag, SparseArray sparsearray, SparseArray sparsearray1)
    {
        ...
        if (obj != null)
        {
            ...
            } else
            {
                ...
                prepareSharedElementTransition(transitionstate, viewgroup, obj, ((Fragment) (inFragment)), ((Fragment) (obj3)), flag, arraylist);
                sparsearray1 = ((SparseArray) (obj));
        ...
        if (inFragment != null)
        {
            FragmentTransitionCompat21.addTransitionTargets(obj2, sparsearray1, viewgroup, ((FragmentTransitionCompat21.ViewRetriever) (obj3)), transitionstate.nonExistentView, transitionstate.enteringEpicenterView, transitionstate.nameOverrides, ((ArrayList) (obj4)), sparsearray, arraymap1, arraylist);
