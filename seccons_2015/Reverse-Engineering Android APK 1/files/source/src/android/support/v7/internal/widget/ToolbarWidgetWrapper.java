...
_L9:
    ...
    public ViewPropertyAnimatorCompat setupAnimatorToVisibility(int i, long l)
    {
        if (i == 8)
        {
            ViewPropertyAnimatorCompat viewpropertyanimatorcompat = ViewCompat.animate(mToolbar).alpha(0.0F);
        ...
        if (i == 0)
        {
            ViewPropertyAnimatorCompat viewpropertyanimatorcompat1 = ViewCompat.animate(mToolbar).alpha(1.0F);
            viewpropertyanimatorcompat1.setDuration(l);
            viewpropertyanimatorcompat1.setListener(new ViewPropertyAnimatorListenerAdapter() {
