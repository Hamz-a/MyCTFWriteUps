...
class TwilightCalculator
{
    ...
    public void calculateTwilight(long l, double d, double d1)
    {
        ...
        double d2 = 1.796593063D + ((double)f1 + 0.033419601619243622D * Math.sin(f1) + 0.00034906598739326D * Math.sin(2.0F * f1) + 5.2360001063789241E-06D * Math.sin(3F * f1)) + 3.1415926535897931D;
        d1 = -d1 / 360D;
        d1 = (double)(0.0009F + (float)Math.round((double)(f - 0.0009F) - d1)) + d1 + 0.0053D * Math.sin(f1) + -0.0068999999999999999D * Math.sin(2D * d2);
