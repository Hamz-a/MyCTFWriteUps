    ...
    implements ViewPager.Decor
{
    ...
    protected void onMeasure(int i, int j)
    {
        ...
        int j1 = android.view.View.MeasureSpec.makeMeasureSpec(Math.max(0, (int)((float)i * 0.8F)), 0x80000000);
        int k1 = android.view.View.MeasureSpec.makeMeasureSpec(Math.min(0, j - i1), 0x80000000);
